  ...
  return (
    <div className="min-h-screen pb-[100rem] bg-[#151414] relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <section className="mt-[9rem] max-w-[77rem] mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={index}
                className="group border-[#2e2e32] hover:border-[#58585f] transition-colors duration-300 py-6 px-8 rounded-lg flex justify-between items-center cursor-pointer border"
              >
                {index % 2 !== 0 && (
        ...
        <section className="mt-[9rem]">
          <div className="min-h-[20rem] w-full bg-[#151414] bg-grid-white/[0.05] relative flex items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <h2 className="text-center text-[3.4rem] font-inter tracking-wide text-[#e5e5e5] leading-[1.1] mb-16">
